      ...
      <div className={styles.menu}>
        <a className={styles.openButton} onClick={() => {
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path fill-rule="evenodd" clip-rule="evenodd" d="M3 13.0093C2.44772 13.0093 2 12.5616 2 12.0093C2 11.457 2.44772 11.0093 3 11.0093H21C21.5523 11.0093 22 11.457 22 12.0093C22 12.5616 21.5523 13.0093 21 13.0093H3ZM3 6.00928C2.44772 6.00928 2 5.56156 2 5.00928C2 4.45699 2.44772 4.00928 3 4.00928H21C21.5523 4.00928 22 4.45699 22 5.00928C22 5.56156 21.5523 6.00928 21 6.00928H3ZM3 20.0093C2.44772 20.0093 2 19.5616 2 19.0093C2 18.457 2.44772 18.0093 3 18.0093H21C21.5523 18.0093 22 18.457 22 19.0093C22 19.5616 21.5523 20.0093 21 20.0093H3Z" fill="#798490"/>
          </svg>
        </a>
